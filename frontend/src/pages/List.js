...
const List = () => {
  ...
  useEffect(() => {
    return () => {
      getAll(tableName, setTable, isChanged);
    };
  }, [isChanged]);
    ...
    return (
      ...
      >
        <div className="w-full h-full right-0 bottom-0 z-50 bg-gray-500/50 overflow-auto flex justify-end">
          <div className="p-2 w-[40em] min-h-full bg-white overflow-y-auto">
            <div className="flex justify-between w-full p-2">
              <button onClick={saveButton}>Save</button>
              <button onClick={newButton}>Close</button>
            </div>
              ...
              Object.values(table.data.columns).map((object) => {
                return (
                  ...
                  >
                    ...
                    <input
                      className="border-2"
                      value={insertValues[object.ColumnName]}
                      onChange={(e) =>
                        setInsertValues((old) => ({
                          ...old,
